  ...
  <v-col cols="3">
    <v-card elevation="0">
      <v-card-title class="grey lighten-3">
        <span class="text-h5 text-capitalize">testing</span>
        <v-spacer></v-spacer>
        <v-menu bottom left>
...
<script>
  ...
  data: () => ({
    ...
    todos:[
    {id: "134533t3r", title: 'ui dsign', startDate: '22 may 2022', dedLine: '16 oct 2022', asignTo: 'admin', importancy: 'high', stage: 'testing', updatedTime: '2:15:17 PM', changes: [],},
    {id: "223523432", title: 'code ready', startDate: '22 may 2022', dedLine: '16 oct 2022', asignTo: 'admin', importancy: 'high', stage: 'testing', updatedTime: '2:15:17 PM', changes: [],},
    {id: "2342432", title: 'front end', startDate: '22 may 2022', dedLine: '16 oct 2022', asignTo: 'admin', importancy: 'high', stage: 'testing', updatedTime: '2:15:17 PM', changes: [],},
    {id: "423234242", title: 'back end complited', startDate: '22 may 2022', dedLine: '16 oct 2022', asignTo: 'admin', importancy: 'high', stage: 'testing', updatedTime: '2:15:17 PM', changes: [],}
  ],
  }),
  computed: {
        users (){
