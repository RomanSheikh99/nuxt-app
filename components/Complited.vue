...
<script>
  ...
  computed: {
    ...
    mounted(){
          this.editedData = {...this.$store.state.complitedTodos.editedData}
          this.todos = [...this.$store.state.complitedTodos.todos]
          this.showTask()
    },
    watch:{
      filterUser(nv){
      ...
      todos(nv){
        this.$store.commit('complitedTodos/addTodos', [...nv])
      },
      editMode(nv){
        this.editedData = {...this.$store.state.complitedTodos.editedData}
        this.todos = [...this.$store.state.complitedTodos.todos]
    ...
    methods:{
      showTask(){
        ...
        log(evt){
          this.$store.commit('complitedTodos/log', {evt: evt, user: this.user, stage: 'complited'})
        },
        openEditModal(id){
          this.$store.commit('complitedTodos/setEditedData', id)
          this.editMode = true;
        },
        addTime(i){
        ...
        submitEditedTask(id){
          this.$store.commit('complitedTodos/editTodo', {id: id, data: this.editedData})
          this.editMode = false;
        },
        addWorkTime(data){
